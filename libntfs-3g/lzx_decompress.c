 ...
 * be used in files that use "System Compression".  This is based on the code
 * from wimlib.  This code only supports a window size (dictionary size) of
 * 32768 bytes, since this is the only size used in System Compression.
 *
